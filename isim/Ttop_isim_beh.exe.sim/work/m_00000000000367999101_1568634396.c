...
LAB45:    if (*((unsigned int *)t60) != 0)
        goto LAB46;

LAB47:    t68 = *((unsigned int *)t48);
...
LAB51:    xsi_set_current_line(140, ng0);
    ...
    t106 = *((char **)t105);
    t105 = (t0 + 7616);
    xsi_vlogvar_assign_value(t105, t106, 0, 0, 12);
    goto LAB53;
