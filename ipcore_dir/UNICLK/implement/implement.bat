...
xst -ifn xst.scr
move UNICLK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\UNICLK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc UNICLK_exdes.ucf UNICLK_exdes

echo 'Running map'
map -timing -pr b UNICLK_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm UNICLK_exdes -w routed.ncd routed.v
cd ..
